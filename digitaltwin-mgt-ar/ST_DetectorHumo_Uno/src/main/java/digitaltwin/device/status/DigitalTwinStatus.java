...
public class DigitalTwinStatus implements IDigitalTwinStatus{
	...
	@Getter
	@Setter
	private Boolean humoDetectado;
	@Getter
	@Setter
	private OperationType operationHumoDetectado;
	...
	public void init() {
		//Init Operation types values
			setOperationHumoDetectado(OperationType.IN);
		
		mapClass = new HashMap<String, Class>();
			mapClass.put("humoDetectado", Boolean.class);
	}
	...
	public Map<String, Object> toMap() {
		Map<String, Object> properties = new HashMap<String, Object>();
			...
			properties.put("humoDetectado",humoDetectado);
